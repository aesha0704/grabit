...
@section('content')
    ...
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <section class="hero bg-image" data-image-src="{{asset('uploads/grabit_logo/grabit.jpg')}}">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & Take-Out </h1>
                    <h5 class="font-white space-xs">Find restaurants, specials, and coupons for free</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="get" action="{{route('front_home.index')}}">
                            @csrf
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to eat....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="sn" placeholder="I would like to eat...." name="sn"> </div>
                            </div>
                            <button  type="submit" class="btn theme-btn btn-lg" id="search_btn">Search food</button>
                        </form>
                    </div>
                    <div class="steps">
    ...
    <!-- location match part ends -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="pull-right">
                        <font size="4px"> <a href="{{url('/front_home/sort')}}" class="m-2">Cost For Two</a>
                            <a href="{{url('/front_home/delivery')}}" class="m-2">Delivery Time</a>
                            <a href="{{url('/front_home/recently')}}" class="m-2">Recently added</a></font>
                    </div>
                </div>
                <hr>
                ...
                <!--                    --><?php //$Shops=\App\Shop::with('shoptiming','cuisines','category','products')->inRandomOrder()->take(3)->get();
                //                    ?>

                @foreach($Shops as $value)
                        <div class="col-xs-12 col-sm-6 col-md-3 food-item">
                            <div class="food-item-wrap">
                                <div class="figure-wrap bg-image"> <image src="{{asset('uploads/shop/logo/'.$value->avatar) }}" height="100%" width="100%"></image></div>
                                <div class="content">
                                    <h5><a href="profile.html">{{$value->name}}</a></h5>
                                    <div class="product-name">{{$value->description}}</div>
                                    <div><i class="fa fa-motorcycle"> &nbsp;{{$value->estimated_delivery_time}}  m</i>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                        <span>{{$value->offer_min_amount}} &nbsp;FOR TWO </span> </div>
                                    <hr>

                                    {{--                                    <div class="product-name">{{$value->products[0]->name}}</div>--}}
                                    <center>   <a  href="{{ route('front_home.show',$value->id) }}" class="btn-success btn"><i class="fa fa-shopping-cart" style="font-size:20px"></i>&nbsp;Order Now</a></center>
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        {{--                            <div class="figure-wrap bg-image" data-image-src="{{asset('uploads/shop/logo/'.$Shops->avatar) }}">--}}
...
{{--        function setFocus() {--}}
{{--            document.getElementById("try1").focus();--}}
{{--        }--}}
{{--    </script>--}}
