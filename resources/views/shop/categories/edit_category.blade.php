                        ...
                        <form method="POST" action="{{ route('categorie.update',$category->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="description" class="form-control" placeholder="Enter Descriptions">{{$category->description}}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        @foreach($category as $key=>$value)
                                            <option value="{{ $key }}" {{ ( $key == $category->id) ? 'selected' : '' }}>
                                                {{ $key }}
                                            </option>
                                        @endforeach
                                    </select>
