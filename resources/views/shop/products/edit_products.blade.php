            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="box box-primary">
                        <!--                        --><?php //$price=\App\ProductPrice::all(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="product_position" value="{{$Product->position}}" name="product_position" required autofocus/>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="price" value="{{ $Prices->price }}" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="discount" type="text" class="form-control" name="discount" value="{{$Prices->discount }}" required autofocus>
