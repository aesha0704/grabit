        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <form role="form" method="POST" action="{{route('users.update',$user->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="" placeholder="E-mail" name="email" value="{{$user->email}}" />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="" name="phone" width="200px" placeholder="Phone Number" value="{{$user->phone}}" />
                        </div>
                    </div>
                    <br>
